...
final class CartControllerStub: CartControllerProtocol {
    ...
    var cart: [NFT] = [
        ...
        NFT(name: "Aurora", images: ["https://code.s3.yandex.net/Mobile/iOS/NFT/Beige/Aurora/1.png"], rating: 4, description: "", price: 2.5, author: "", id: "2", createdAt: ""),
        NFT(name: "Bimbo", images: ["https://code.s3.yandex.net/Mobile/iOS/NFT/Beige/Bimbo/1.png"], rating: 3, description: "", price: 6, author: "", id: "3", createdAt: ""),
